  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      bind = [
        ...
        "$mod, W, exec, pkill rofi || rofi -show calc -modi calc -no-show-match -no-sort"
        "$mod, Return, exec, ${uwsm} kitty"
        "$mod+Alt, semicolon, exec, ${uwsm} brave --profile-directory='Default'"
        "$mod, semicolon, exec, ${uwsm} brave  --profile-directory='Profile 1'"
